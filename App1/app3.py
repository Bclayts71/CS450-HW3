...
@app.callback([Output('graph1', 'figure'),Output('radio', 'options'),Output('radio', 'value')], [Input('x-axis-dropdown', 'value'),Input('y-axis-dropdown', 'value')])
def update_graph(x_axis_column, y_axis_column):
    ...
    return figure,tips_df[x_axis_column].unique(),tips_df[x_axis_column].unique()[0]
